...
(async() => {
    ...
    let contract = new Contract('localhost', () => {
      ...
      contract.flightSuretyApp.events.FlightStatusInfo({
        ...
        contract.flightSuretyApp.methods.getNewAirlines().call({ from: contract.owner}, (error, result) => {
            //console.log("**************   result" + result + " contract.airlines[]=" + contract.airlines[]);
            console.log("**************   result" + result + " contract.flights['AirAB1']=" + contract.flights['AirAB1']);
        ...
        DOM.elid('register-Airline').addEventListener('click', () => {
            ...
            let airlinetoregistername = DOM.elid('airlineaddress').name;
            console.log("to airline:" + airlinetoregister + " airlinetoregistername=" + airlinetoregistername);
            let fromairline = x.options[x.selectedIndex].value; 
            console.log("from:" + fromairline + " airlinetoregister=" + airlinetoregister);
            contract.registerAirline(fromairline,airlinetoregister, airlinetoregistername, (error,result) => {
        ...
        DOM.elid('insuredairline').addEventListener('change', () => {
            let airline = DOM.elid('insuredairline').value;
            console.log("insuredairline airline" + airline);
...
function initialize(allflights,airlines)
{
    //initialize flights
    let airline = DOM.elid('insuredairline').value; 
    console.log("initialize: airline=" + airline);
    let selectedairline = airlines[airline];
    console.log("initialize: selectedairline=" + selectedairline);
...
function populateRegisteredAirlines(airlines,registeredAirlines,airlineel){
    ...
    list.innerHTML = "";
    console.log("populateRegisteredAirlines: registeredAirlines=" + registeredAirlines);
